...
function PerformanceSummary(props) {
  const columns = [
    ...
    {
      title: "交易收益",
      dataIndex: "total_profit_trade",
      key: "total_profit_trade",
      render: (text) => <ColorMoney value={text} type="num" />,
    },
    {
      title: "分红收益",
      dataIndex: "total_profit_dividend",
      key: "total_profit_dividend",
      render: (text) => <ColorMoney value={text} type="num" />,
    },
    {
      title: "融资收益",
      dataIndex: "total_profit_finance",
      key: "total_profit_finance",
      render: (text) => <ColorMoney value={text} type="num" />,
    },
    {
      title: "市值",
  ...
  let data = [{
    ...
    year_return_rate: '--',
    total_profit_trade: '--',
    total_profit_dividend: '--',
    total_profit_finance: '--',
    total_profit: '--',
    total_profit_rate: '--',
    total_other_income: '--',
    key: 1,
